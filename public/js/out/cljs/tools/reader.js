...
var G__24830 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__24830;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__24831 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24831,ch);
...
if(("\\" === ch__$1)){
var ch_24832__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_24832__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_24832__$2);
} else {
}

var G__24833 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__24833;
continue;
}
}
...
var G__24844 = cljs.core.conj_BANG_.call(null,a,form);
a = G__24844;
continue;
}
}
...
var _STAR_read_delim_STAR_24845 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_24845;
}});
/**
...
var vec__24858 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24858,(0),null);
var start_column = cljs.core.nth.call(null,vec__24858,(1),null);
...
var vec__24861 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24861,(0),null);
var end_column = cljs.core.nth.call(null,vec__24861,(1),null);
...
var sb = (function (){var G__24864 = (new goog.string.StringBuffer());
G__24864.append(initch);
...
var G__24866 = (function (){var G__24865 = sb;
G__24865.append(ch);

return G__24865;
})();
var G__24867 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__24866;
ch = G__24867;
continue;
}
...
switch (G__24870) {
case "\\":
var G__24874 = (function (){var G__24871 = sb;
G__24871.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__24871;
})();
var G__24875 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24874;
ch = G__24875;
continue;
...
break;
default:
var G__24876 = (function (){var G__24872 = sb;
G__24872.append(ch);

return G__24872;
})();
var G__24877 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__24876;
ch = G__24877;
continue;
...
var vec__24878 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24878,(0),null);
var end_column = cljs.core.nth.call(null,vec__24878,(1),null);
...
var line = cljs.core.nth.call(null,vec__24891,(0),null);
var column = cljs.core.nth.call(null,vec__24891,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__24896 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__24896,(0),null);
var start_column = cljs.core.nth.call(null,vec__24896,(1),null);
...
var vec__24899 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__24899,(0),null);
var end_column = cljs.core.nth.call(null,vec__24899,(1),null);
...
var G__24902 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__24902,true,null,opts,pending_forms);
...
var G__24903 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__24903)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__24903)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__24903)){
...
var _STAR_suppress_read_STAR_24904 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_24904;
}});
...
var _STAR_suppress_read_STAR_24911 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_24911;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env24912 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__24913 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__24913,"(");
...
var G__24914 = (i + (1));
var G__24915 = cljs.core.conj_BANG_.call(null,args,(function (){var or__3922__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__3922__auto__)){
return or__3922__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env24912;
}});
/**
...
var ch = temp__5455__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__24916 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__24916);
...
var G__24917 = cljs.core.next.call(null,s__$1);
var G__24918 = ret;
s__$1 = G__24917;
r = G__24918;
continue;
...
var G__24919 = cljs.core.next.call(null,s);
var G__24920 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__24919;
key_vals = G__24920;
continue;
} else {
...
var gensym_env24924 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env24924;
}});
...
var temp__5455__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__24925 = token;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq24944){
...
//# sourceMappingURL=reader.js.map?rel=1530621483821
