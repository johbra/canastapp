...
}catch (e29602){var _e = e29602;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5455__auto___29605 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5455__auto___29605)){
var seen_errors_29606 = temp__5455__auto___29605;
if(cljs.core.truth_(seen_errors_29606.has(self))){
} else {
seen_errors_29606.add(self);

var temp__5457__auto___29607 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5457__auto___29607)){
var sense_29608 = temp__5457__auto___29607;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_29608)].join('');
} else {
}
}
} else {
...
//# sourceMappingURL=hints.js.map?rel=1530821395347
