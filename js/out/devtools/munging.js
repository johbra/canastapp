...
var o22667 = temp__5455__auto__;
var temp__5455__auto____$1 = (o22667["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22668 = temp__5455__auto____$1;
return (o22668["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__22202__auto__ = f;
return (o__22202__auto__["toString"]).call(o__22202__auto__);
} else {
return "";
}
}catch (e22669){var _ = e22669;
return "";
}});
...
try{var o__22202__auto___22671 = t;
(o__22202__auto___22671["cljs$lang$ctorPrWriter"]).call(o__22202__auto___22671,t,writer);
}catch (e22670){var __22672 = e22670;
}
...
var char_code = (function (){var o__22202__auto__ = (new String(char$));
return (o__22202__auto__["charCodeAt"]).call(o__22202__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__22202__auto__ = String;
return (o__22202__auto__["fromCharCode"]).call(o__22202__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22673 = num_code;
switch (G__22673) {
case (1):
return (185);
...
var o__22202__auto__ = String;
return (o__22202__auto__["fromCharCode"]).call(o__22202__auto__,superscript_code);
});
/**
...
}catch (e22675){var _e__22209__auto__ = e22675;
return false;
}})())){
...
var vec__22676 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22676,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o22679 = temp__5455__auto__;
var temp__5455__auto____$1 = (o22679["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22680 = temp__5455__auto____$1;
return (o22680["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22683){
var vec__22684 = p__22683;
var ns_detector = cljs.core.nth.call(null,vec__22684,(0),null);
...
var G__22690 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22691 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22690;
remaining_tokens = G__22691;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22681){
...
var vec__22695 = cljs.core.split_with.call(null,(function (p1__22694_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22694_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22695,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22695,(1),null);
...
var vec__22698 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22698,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22698,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22701 = cljs.core.rest.call(null,remaining_tokens);
var G__22702 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22701;
name_tokens = G__22702;
continue;
} else {
...
var vec__22705 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22705,(0),null);
var arity = cljs.core.nth.call(null,vec__22705,(1),null);
var vec__22708 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22708,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22708,(1),null);
var vec__22711 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22711,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22711,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22711,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22711,(3),null);
...
var vec__22717 = result;
var munged_ns = cljs.core.nth.call(null,vec__22717,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22717,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22717,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22717,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22717,(4),null);
var arity = cljs.core.nth.call(null,vec__22717,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__22721 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__22721,(0),null);
var args = cljs.core.nth.call(null,vec__22721,(1),null);
var vec__22724 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22724,(0),null);
var name = cljs.core.nth.call(null,vec__22724,(1),null);
...
var G__22727 = (arity + (1));
var G__22728 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22729){
var vec__22730 = p__22729;
var arity = cljs.core.nth.call(null,vec__22730,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22730,(1),null);
...
return cljs.core.get.call(null,arities,p1__22733_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__22734_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22737){
var vec__22738 = p__22737;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22738,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22735){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22746__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22746__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22746__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22746__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22747 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22747,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22747,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22747,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22747,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22747,(4),null);
var arity = cljs.core.nth.call(null,vec__22747,(5),null);
...
var o__22202__auto__ = f;
return (o__22202__auto__["getBasis"]).call(o__22202__auto__);
});
/**
...
}catch (e22751){var _e__22209__auto__ = e22751;
...
var G__22752 = (obj[cljs.core.first.call(null,path)]);
var G__22753 = cljs.core.rest.call(null,path);
obj = G__22752;
path = G__22753;
continue;
} else {
...
return (function (accum,p__22754){
var vec__22755 = p__22754;
var bit = cljs.core.nth.call(null,vec__22755,(0),null);
var protocol = cljs.core.nth.call(null,vec__22755,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22758){
var vec__22759 = p__22758;
var ns = cljs.core.nth.call(null,vec__22759,(0),null);
var name = cljs.core.nth.call(null,vec__22759,(1),null);
var selector = cljs.core.nth.call(null,vec__22759,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__22764,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22764,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__22764,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__22762_SHARP_){
return (obj[cljs.core.first.call(null,p1__22762_SHARP_)]);
});})(name,sorted_matches,vec__22764,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1530621472224
