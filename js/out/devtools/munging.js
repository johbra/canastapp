...
var o22666 = temp__5455__auto__;
var temp__5455__auto____$1 = (o22666["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22667 = temp__5455__auto____$1;
return (o22667["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
try{var o__22201__auto___22670 = t;
(o__22201__auto___22670["cljs$lang$ctorPrWriter"]).call(o__22201__auto___22670,t,writer);
}catch (e22669){var __22671 = e22669;
}
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__22672 = num_code;
switch (G__22672) {
case (1):
return (185);
...
}catch (e22674){var _e__22208__auto__ = e22674;
return false;
}})())){
...
var vec__22675 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__22675,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o22678 = temp__5455__auto__;
var temp__5455__auto____$1 = (o22678["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o22679 = temp__5455__auto____$1;
return (o22679["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4499__auto___22686 = arguments.length;
var i__4500__auto___22687 = (0);
while(true){
if((i__4500__auto___22687 < len__4499__auto___22686)){
args__4502__auto__.push((arguments[i__4500__auto___22687]));

var G__22688 = (i__4500__auto___22687 + (1));
i__4500__auto___22687 = G__22688;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__22682){
var vec__22683 = p__22682;
var ns_detector = cljs.core.nth.call(null,vec__22683,(0),null);
...
var G__22689 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__22690 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__22689;
remaining_tokens = G__22690;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq22680){
...
var vec__22694 = cljs.core.split_with.call(null,(function (p1__22693_SHARP_){
return cljs.core.not_EQ_.call(null,p1__22693_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__22694,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__22694,(1),null);
...
var vec__22697 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__22697,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__22697,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__22700 = cljs.core.rest.call(null,remaining_tokens);
var G__22701 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__22700;
name_tokens = G__22701;
continue;
} else {
...
var vec__22704 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__22704,(0),null);
var arity = cljs.core.nth.call(null,vec__22704,(1),null);
var vec__22707 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__22707,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__22707,(1),null);
var vec__22710 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__22710,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__22710,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__22710,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__22710,(3),null);
...
var vec__22716 = result;
var munged_ns = cljs.core.nth.call(null,vec__22716,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__22716,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__22716,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__22716,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__22716,(4),null);
var arity = cljs.core.nth.call(null,vec__22716,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__22720 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__22720,(0),null);
var args = cljs.core.nth.call(null,vec__22720,(1),null);
var vec__22723 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__22723,(0),null);
var name = cljs.core.nth.call(null,vec__22723,(1),null);
...
var G__22726 = (arity + (1));
var G__22727 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__22728){
var vec__22729 = p__22728;
var arity = cljs.core.nth.call(null,vec__22729,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__22729,(1),null);
...
return cljs.core.get.call(null,arities,p1__22732_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__22733_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__22736){
var vec__22737 = p__22736;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__22737,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq22734){
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__22745__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__22745__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__22745__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__22745__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__22746 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__22746,(0),null);
var fn_name = cljs.core.nth.call(null,vec__22746,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__22746,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__22746,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__22746,(4),null);
var arity = cljs.core.nth.call(null,vec__22746,(5),null);
...
}catch (e22750){var _e__22208__auto__ = e22750;
...
var G__22751 = (obj[cljs.core.first.call(null,path)]);
var G__22752 = cljs.core.rest.call(null,path);
obj = G__22751;
path = G__22752;
continue;
} else {
...
return (function (accum,p__22753){
var vec__22754 = p__22753;
var bit = cljs.core.nth.call(null,vec__22754,(0),null);
var protocol = cljs.core.nth.call(null,vec__22754,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__22757){
var vec__22758 = p__22757;
var ns = cljs.core.nth.call(null,vec__22758,(0),null);
var name = cljs.core.nth.call(null,vec__22758,(1),null);
var selector = cljs.core.nth.call(null,vec__22758,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__22763,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__22763,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__22763,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__22761_SHARP_){
return (obj[cljs.core.first.call(null,p1__22761_SHARP_)]);
});})(name,sorted_matches,vec__22763,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1530742078729
