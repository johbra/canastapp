...
return (new CustomEvent(event_name,(function (){var obj29633 = {"detail":data};
return obj29633;
})()));
} else {
...
var f = (function (){var pred__29640 = cljs.core._EQ_;
var expr__29641 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__29640.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__29641))){
return ((function (pred__29640,expr__29641){
return (function (p1__29634_SHARP_){
return console.warn(p1__29634_SHARP_);
});
;})(pred__29640,expr__29641))
} else {
if(cljs.core.truth_(pred__29640.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__29641))){
return ((function (pred__29640,expr__29641){
return (function (p1__29635_SHARP_){
return console.debug(p1__29635_SHARP_);
});
;})(pred__29640,expr__29641))
} else {
if(cljs.core.truth_(pred__29640.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__29641))){
return ((function (pred__29640,expr__29641){
return (function (p1__29636_SHARP_){
return console.error(p1__29636_SHARP_);
});
;})(pred__29640,expr__29641))
} else {
return ((function (pred__29640,expr__29641){
return (function (p1__29637_SHARP_){
return console.log(p1__29637_SHARP_);
});
;})(pred__29640,expr__29641))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__29644){
...
var eval_fn = cljs.core.get.call(null,map__29645__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__29647_SHARP_);
});})(new_def))
);
...
return (function (p__29648){
var vec__29649 = p__29648;
var ky = cljs.core.nth.call(null,vec__29649,(0),null);
var v = cljs.core.nth.call(null,vec__29649,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1530621493261
