...
return (new CustomEvent(event_name,(function (){var obj29678 = {"detail":data};
return obj29678;
})()));
} else {
...
var f = (function (){var pred__29685 = cljs.core._EQ_;
var expr__29686 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__29685.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__29686))){
return ((function (pred__29685,expr__29686){
return (function (p1__29679_SHARP_){
return console.warn(p1__29679_SHARP_);
});
;})(pred__29685,expr__29686))
} else {
if(cljs.core.truth_(pred__29685.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__29686))){
return ((function (pred__29685,expr__29686){
return (function (p1__29680_SHARP_){
return console.debug(p1__29680_SHARP_);
});
;})(pred__29685,expr__29686))
} else {
if(cljs.core.truth_(pred__29685.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__29686))){
return ((function (pred__29685,expr__29686){
return (function (p1__29681_SHARP_){
return console.error(p1__29681_SHARP_);
});
;})(pred__29685,expr__29686))
} else {
return ((function (pred__29685,expr__29686){
return (function (p1__29682_SHARP_){
return console.log(p1__29682_SHARP_);
});
;})(pred__29685,expr__29686))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__29689){
...
var eval_fn = cljs.core.get.call(null,map__29690__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__29692_SHARP_);
});})(new_def))
);
...
return (function (p__29693){
var vec__29694 = p__29693;
var ky = cljs.core.nth.call(null,vec__29694,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1530821396101
