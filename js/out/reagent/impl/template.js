...
var G__28897 = o;
(G__28897[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__28898__delegate = function (args){
...
return G__28898__delegate.call(this,args);};
G__28898.cljs$lang$maxFixedArity = 0;
G__28898.cljs$lang$applyTo = (function (arglist__28900){
var args = cljs.core.seq(arglist__28900);
return G__28898__delegate(args);
});
...
var G__28901 = o;
(G__28901[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__28903__i < G__28903__a.length) {G__28903__a[G__28903__i] = arguments[G__28903__i + 0]; ++G__28903__i;}
  args = new cljs.core.IndexedSeq(G__28903__a,0,null);
} 
...
var G__28906 = props;
var G__28906__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__28906,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__28906);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__28906__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__28907){
var map__28908 = p__28907;
var map__28908__$1 = ((((!((map__28908 == null)))?(((((map__28908.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28908.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__28908):map__28908);
var props = map__28908__$1;
var class$ = cljs.core.get.call(null,map__28908__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__28908,map__28908__$1,props,class$){
return (function (c){
...
});})(map__28908,map__28908__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__28910){
...
var on_write = cljs.core.get.call(null,map__28911__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__28911,map__28911__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__28911,map__28911__$1,on_write))
);
} else {
...
var G__28914 = jsprops;
(G__28914["defaultValue"] = value);

(G__28914["onChange"] = ((function (G__28914,v,value,on_change){
return (function (p1__28913_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__28913_SHARP_);
});})(G__28914,v,value,on_change))
);
...
var vec__28917 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__28917,(0),null);
var id = cljs.core.nth.call(null,vec__28917,(1),null);
var class$ = cljs.core.nth.call(null,vec__28917,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___28921 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___28921 == null)){
} else {
var key_28922 = temp__5461__auto___28921;
(jsprops["key"] = key_28922);
}
...
var temp__5461__auto___28923 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___28923 == null)){
} else {
var key_28924 = temp__5461__auto___28923;
reagent.impl.template.oset.call(null,jsprops,"key",key_28924);
}
...
var G__28925 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__28925["name"] = c);
...
var len__4499__auto___28930 = arguments.length;
var i__4500__auto___28931 = (0);
while(true){
if((i__4500__auto___28931 < len__4499__auto___28930)){
args__4502__auto__.push((arguments[i__4500__auto___28931]));

var G__28932 = (i__4500__auto___28931 + (1));
i__4500__auto___28931 = G__28932;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq28928){
...
break;
default:
var G__28935 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__28935;
continue;
...
var n__4376__auto___28937 = a.length;
var i_28938 = (0);
while(true){
if((i_28938 < n__4376__auto___28937)){
(a[i_28938] = reagent.impl.template.as_element.call(null,(a[i_28938])));
...
var a = cljs.core.into_array.call(null,s);
var n__4376__auto___28940 = a.length;
var i_28941 = (0);
while(true){
if((i_28941 < n__4376__auto___28940)){
var val_28942 = (a[i_28941]);
if(((cljs.core.vector_QMARK_.call(null,val_28942)) && ((reagent.impl.template.key_from_vec.call(null,val_28942) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_28941] = reagent.impl.template.as_element.call(null,val_28942));

var G__28943 = (i_28941 + (1));
i_28941 = G__28943;
continue;
} else {
}
...
var ctx = ({});
var vec__28944 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__28944,(0),null);
var derefed = cljs.core.nth.call(null,vec__28944,(1),null);
...
var G__28947 = (cljs.core.count.call(null,argv) - first_child);
switch (G__28947) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__28947){
...
//# sourceMappingURL=template.js.map?rel=1530972544899
