...
var G__28896 = o;
(G__28896[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
var G__28900 = o;
(G__28900[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
while (G__28902__i < G__28902__a.length) {G__28902__a[G__28902__i] = arguments[G__28902__i + 0]; ++G__28902__i;}
  args = new cljs.core.IndexedSeq(G__28902__a,0,null);
} 
...
var G__28905 = props;
var G__28905__$1 = ((((!((id == null))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__28905,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__28905);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__28905__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__28906){
...
var props = map__28907__$1;
var class$ = cljs.core.get.call(null,map__28907__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__28907,map__28907__$1,props,class$){
return (function (c){
...
});})(map__28907,map__28907__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__28909){
...
var on_write = cljs.core.get.call(null,map__28910__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__28910,map__28910__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__28910,map__28910__$1,on_write))
);
} else {
...
var G__28913 = jsprops;
(G__28913["defaultValue"] = value);

(G__28913["onChange"] = ((function (G__28913,v,value,on_change){
return (function (p1__28912_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__28912_SHARP_);
});})(G__28913,v,value,on_change))
);
...
var vec__28916 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__28916,(0),null);
var id = cljs.core.nth.call(null,vec__28916,(1),null);
var class$ = cljs.core.nth.call(null,vec__28916,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___28920 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___28920 == null)){
} else {
var key_28921 = temp__5461__auto___28920;
(jsprops["key"] = key_28921);
}
...
var temp__5461__auto___28922 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___28922 == null)){
} else {
var key_28923 = temp__5461__auto___28922;
reagent.impl.template.oset.call(null,jsprops,"key",key_28923);
}
...
var G__28924 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__28924["name"] = c);
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq28927){
var G__28928 = cljs.core.first.call(null,seq28927);
var seq28927__$1 = cljs.core.next.call(null,seq28927);
var self__4486__auto__ = this;
return self__4486__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28928,seq28927__$1);
});
...
break;
default:
var G__28934 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__28934;
continue;
...
var n__4376__auto___28936 = a.length;
var i_28937 = (0);
while(true){
if((i_28937 < n__4376__auto___28936)){
(a[i_28937] = reagent.impl.template.as_element.call(null,(a[i_28937])));
...
var a = cljs.core.into_array.call(null,s);
var n__4376__auto___28939 = a.length;
var i_28940 = (0);
while(true){
if((i_28940 < n__4376__auto___28939)){
var val_28941 = (a[i_28940]);
if(((cljs.core.vector_QMARK_.call(null,val_28941)) && ((reagent.impl.template.key_from_vec.call(null,val_28941) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_28940] = reagent.impl.template.as_element.call(null,val_28941));

var G__28942 = (i_28940 + (1));
i_28940 = G__28942;
continue;
} else {
}
...
var ctx = ({});
var vec__28943 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__28943,(0),null);
var derefed = cljs.core.nth.call(null,vec__28943,(1),null);
...
var G__28946 = (cljs.core.count.call(null,argv) - first_child);
switch (G__28946) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__28946){
...
//# sourceMappingURL=template.js.map?rel=1530742095540
